...
export function TeamSignal({ image, name }: { code: string; image?: string; name: string }) {
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col items-center gap-1 sm:flex-none">
      <span className="next-match-country-code text-5xl font-normal leading-none text-volt/90 sm:text-7xl" style={{ fontFamily: "ScreenMatrix, monospace" }}>{shortCode}</span>
