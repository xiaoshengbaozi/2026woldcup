...
export const SUPERSTAR_AVATARS = [
  { id: "lionel-messi", name: "Messi", image: "/player-stories/26_superstars/avatar-webp/Lionel_Messi_avatar.webp" },
  { id: "kylian-mbappe", name: "Mbappe", image: "/player-stories/26_superstars/avatar-webp/Kylian_Mbappe_avatar.webp" },
  { id: "erling-haaland", name: "Haaland", image: "/player-stories/26_superstars/avatar-webp/Erling_Haaland_avatar.webp" },
  { id: "vinicius-junior", name: "Vinicius", image: "/player-stories/26_superstars/avatar-webp/Vinicius_Junior_avatar.webp" },
  { id: "jude-bellingham", name: "Bellingham", image: "/player-stories/26_superstars/avatar-webp/Jude_Bellingham_avatar.webp" },
  { id: "harry-kane", name: "Kane", image: "/player-stories/26_superstars/avatar-webp/Harry_Kane_avatar.webp" },
  { id: "cristiano-ronaldo", name: "Ronaldo", image: "/player-stories/26_superstars/avatar-webp/Cristiano_Ronaldo_avatar.webp" },
  { id: "mohamed-salah", name: "Salah", image: "/player-stories/26_superstars/avatar-webp/Mohamed_Salah_avatar.webp" },
  { id: "kevin-de-bruyne", name: "De Bruyne", image: "/player-stories/26_superstars/avatar-webp/Kevin_De_Bruyne_avatar.webp" },
  { id: "bruno-fernandes", name: "Bruno", image: "/player-stories/26_superstars/avatar-webp/Bruno_Fernandes_avatar.webp" },
  { id: "federico-valverde", name: "Valverde", image: "/player-stories/26_superstars/avatar-webp/Federico_Valverde_avatar.webp" },
  { id: "luka-modric", name: "Modric", image: "/player-stories/26_superstars/avatar-webp/Luka_Modric_avatar.webp" },
  { id: "raphinha", name: "Raphinha", image: "/player-stories/26_superstars/avatar-webp/Raphinha_avatar.webp" },
  { id: "julian-alvarez", name: "Alvarez", image: "/player-stories/26_superstars/avatar-webp/Julian_Alvarez_avatar.webp" },
  { id: "pedri", name: "Pedri", image: "/player-stories/26_superstars/avatar-webp/Pedri_avatar.webp" },
  { id: "florian-wirtz", name: "Wirtz", image: "/player-stories/26_superstars/avatar-webp/Florian_Wirtz_avatar.webp" },
  { id: "son-heungmin", name: "Son", image: "/player-stories/26_superstars/avatar-webp/Son_Heungmin_avatar.webp" },
  { id: "lamine-yamal", name: "Yamal", image: "/player-stories/26_superstars/avatar-webp/Lamine_Yamal_avatar.webp" },
  { id: "enzo-fernandez", name: "Enzo", image: "/player-stories/26_superstars/avatar-webp/Enzo_Fernandez_avatar.webp" },
  { id: "luis-diaz", name: "Luis Diaz", image: "/player-stories/26_superstars/avatar-webp/Luis_Diaz_avatar.webp" },
  { id: "ousmane-dembele", name: "Dembele", image: "/player-stories/26_superstars/avatar-webp/Ousmane_Dembele_avatar.webp" },
  { id: "sadio-mane", name: "Mane", image: "/player-stories/26_superstars/avatar-webp/Sadio_Mane_avatar.webp" },
  { id: "riyad-mahrez", name: "Mahrez", image: "/player-stories/26_superstars/avatar-webp/Riyad_Mahrez_avatar.webp" },
  { id: "moises-caicedo", name: "Caicedo", image: "/player-stories/26_superstars/avatar-webp/Moises_Caicedo_avatar.webp" },
  { id: "michael-olise", name: "Olise", image: "/player-stories/26_superstars/avatar-webp/Michael_Olise_avatar.webp" },
  { id: "christian-pulisic", name: "Pulisic", image: "/player-stories/26_superstars/avatar-webp/Christian_Pulisic_avatar.webp" },
];
